    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img src="https://img.freepik.com/premium-vector/abstract-initial-letter-jg-gj-logo-blue-color-isolated-white-background_388320-1006.jpg?semt=ais_hybrid&w=740" alt="Your Company" class="size-8" />
          </div>
